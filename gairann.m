...
for x=3:2:386 %データ読み取り数によって変更
    ...
    dtheta_ = [dtheta1;dtheta2;dtheta3;dtheta4;dtheta5;dtheta6;dtheta7;dtheta8;dtheta9];


    dtheta = dtheta_/dt; %リンクの角速度 rad/s

    dtheta = lowpass(dtheta_, fc, 1/dt);
    ...
    data1 = [data1; data(x-1,1), data(x-1,20),f',tau',theta',dtheta'];
end
...
plot(data1(:,1), data1(:,2),"LineWidth",2,"Color","r");
plot(data1(:,1), data1(:,3)+data1(:,5),"LineWidth",2,"Color","b");
plot(data1(:,1), -data1(:,7),"LineWidth",2,"Color","g");
fontsize(16,"points")
% legend({'計測値','左','右'},'Interpreter','latex')
%     fontsize(10,"points")
xlabel('Time[s]','FontSize',16)
ylabel('Force[N]','FontSize',16)
% figure(3);clf;hold('on');
% plot(data1(:,1), data1(:,4)+data1(:,6),"LineWidth",2,"Color","r");
% fontsize(16,"points")
% xlabel('Time[s]','FontSize',16)
% ylabel('Force[N]','FontSize',16)
...
% ylabel('Force[N]','FontSize',16)
figure(6);clf;hold('on');
plot(data1(:,1), data1(:,18)*180/pi,"LineWidth",2,"Color","r"); %1
plot(data1(:,1), data1(:,19)*180/pi,"LineWidth",2,"Color","b"); %2
plot(data1(:,1), data1(:,20)*180/pi,"LineWidth",2,"Color","g"); %3
plot(data1(:,1), data1(:,21)*180/pi,"LineWidth",2,"Color","c"); %4
plot(data1(:,1), data1(:,22)*180/pi,"LineWidth",2,"Color","m"); %5
plot(data1(:,1), data1(:,23)*180/pi,"LineWidth",2,"Color","y"); %6
plot(data1(:,1), data1(:,24)*180/pi,"LineWidth",2,"Color","k"); %7
plot(data1(:,1), data1(:,25)*180/pi,"LineWidth",2,"Linestyle","--"); %8
plot(data1(:,1), data1(:,26)*180/pi,"LineWidth",2,"Linestyle","-."); %9
fontsize(16,"points")
xlabel('Time[s]','FontSize',16)
...
figure(7);clf;hold('on');
plot(data1(:,1), data1(:,27),"LineWidth",2,"Color","r"); %1
plot(data1(:,1), data1(:,28),"LineWidth",2,"Color","b"); %2
plot(data1(:,1), data1(:,29),"LineWidth",2,"Color","g"); %3
plot(data1(:,1), data1(:,30),"LineWidth",2,"Color","c"); %4
plot(data1(:,1), data1(:,31),"LineWidth",2,"Color","m"); %5
plot(data1(:,1), data1(:,32),"LineWidth",2,"Color","y"); %6
plot(data1(:,1), data1(:,33),"LineWidth",2,"Color","k"); %7
plot(data1(:,1), data1(:,34),"LineWidth",2,"Linestyle","--"); %8
plot(data1(:,1), data1(:,35),"LineWidth",2,"Linestyle","-."); %9
fontsize(16,"points")
xlabel('Time[s]','FontSize',16)
ylabel('velocity[rad/s]','FontSize',16)
